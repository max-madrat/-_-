...
> Каждая функция тестируется на нескольких масивах. В результате работы выводится вес каждого массива и время необходимое для реализации функции для него. При тестировании замечены разные результаты по времени, и из-за маленького объема данных случается, что время работы отличается либо на малую величину, либо не отличается вовсе
